...
int rgb[] = {0,0,255};
int temps = 1000;
BlinkM_setRGB( matrix[1][5], rgb[0], rgb[1], rgb[2]); // Ces lignes correspondent aux "cases" qui restent constamment allumées  
BlinkM_setRGB( matrix[7][2], rgb[0], rgb[1], rgb[2]);
BlinkM_setRGB( matrix[2][2], rgb[0], rgb[1], rgb[2]);
BlinkM_setRGB( matrix[2][6], rgb[0], rgb[1], rgb[2]);
BlinkM_setRGB( matrix[7][6], rgb[0], rgb[1], rgb[2]);
...
BlinkM_setRGB( matrix[4][7], rgb[0], rgb[1], rgb[2]); 
BlinkM_setRGB( matrix[5][4], rgb[0], rgb[1], rgb[2]); 
BlinkM_setRGB( matrix[5][5], rgb[0], rgb[1], rgb[2]); 
BlinkM_setRGB( matrix[5][7], rgb[0], rgb[1], rgb[2]); 
BlinkM_setRGB( matrix[8][5], rgb[0], rgb[1], rgb[2]);  
...
BlinkM_setRGB( matrix[2][1], rgb[0], rgb[1], rgb[2]); 
BlinkM_setRGB( matrix[3][1], rgb[0], rgb[1], rgb[2]); 
BlinkM_setRGB( matrix[6][1], rgb[0], rgb[1], rgb[2]); 
BlinkM_setRGB( matrix[7][1], rgb[0], rgb[1], rgb[2]); 
delay(temps);
BlinkM_setRGB( matrix[2][1], 0, 0, 0); 
BlinkM_setRGB( matrix[3][1], 0, 0, 0); 
BlinkM_setRGB( matrix[6][1], 0, 0, 0); 
BlinkM_setRGB( matrix[7][1], 0, 0, 0); 
delay(400);
